...
.. warning::
    This module provides the legacy algorithm. Use :ref:`apl-GB-classification-label` instead for improved performance.
    For more information about the differences between Gradient Boosting models and Legacy models,
    see `Gradient Boosting Versus Legacy Models <https://help.sap.com/docs/apl/7223667230cb471ea916200712a9c682/4fca173ac74f4547a2314620b58da392.html>`_.
...
class AutoClassifier(RobustRegressionBase):
    ...
    .. warning::
        This is a legacy algorithm. Use :class:`GradientBoostingBinaryClassifier` instead for improved performance.
        For more information about the differences between Gradient Boosting models and Legacy models,
        see `Gradient Boosting Versus Legacy Models <https://help.sap.com/docs/apl/7223667230cb471ea916200712a9c682/4fca173ac74f4547a2314620b58da392.html>`_.
