...
class HANAScheduler(object):
    ...
    def _check_scheduled_procedure(self, procedure_name):
        ...
        schema_job_pair_list = to_numpy(
            list_schedules[
                (list_schedules["PROCEDURE_SCHEMA_NAME"] == procedure_schema)
                & (list_schedules["PROCEDURE_NAME"] == procedure_name)
            ][["SCHEMA_NAME", "SCHEDULER_JOB_NAME"]]
        ).tolist()
