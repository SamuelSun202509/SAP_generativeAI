...
class OutputProgressStatusToUITask(AbstractOutputProgressStatusTask):
    ...
    def init(self):
        ...
        if config.runtime_platform in ['vscode', 'bas']:
            ...
            EmbeddedUI.print_tips_to_install_vscode_extension("cancel AutoML execution")
